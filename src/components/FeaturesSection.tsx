      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-16 md:gap-24 relative z-10">
        ...
        >
          <div className="relative group perspective-1000 float-animation">
            ...
            <div className="relative glass border border-white/20 p-3 rounded-[2.5rem] shadow-2xl transform transition-transform duration-700 group-hover:rotate-y-6">
              ...
              <img
                src={showcaseImage}
                alt=" ‘ﬂÌ·… „’‰⁄ «·ﬂÌ‰Ã - ·ÌÃ‰ »‰« Ì Ã„·… ÊﬂÊ·Ê‰ »‰« Ì Ê„„·«»” √ÿ›«· »«·Ã„·…"
                width={600}
                height={800}
                loading="lazy"
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-black text-foreground">ÃÊœ… ›«∆ﬁ…</div>
                    <div className="text-xs text-muted-foreground">Œ«„«  „Œ «—… »⁄‰«Ì…</div>
                  </div>
                </div>
              </motion.div>
            </div>
        ...
        >
          ...
          <ul className="space-y-8 text-base md:text-lg text-muted-foreground relative">
            ...
            {[
              { title: "Œ«„«  ﬁÿ‰Ì… ›«Œ—…", desc: "‰‰ ﬁÌ √ÃÊœ √‰Ê«⁄ «·ﬁÿ‰ «·„’—Ì ·÷„«‰ „·„” ‰«⁄„ ÌÕ„Ì »‘—… ÿ›· ﬂ „‰ «· Õ””. ·ÌÃ‰ ﬁÿ‰ „’—Ì „„ «“." },
              { title: "„—Ê‰… ÊÕ—Ì… ›Ì «·Õ—ﬂ…", desc: " ’„Ì„«  „ÿ«ÿÌ… „—‰…   ﬂÌ› „⁄ Õ—ﬂ… «·√ÿ›«· «·„” „—…° Ê Ê›— √ﬁ’Ï œ—Ã«  «·—«Õ…. ·ÌÃ‰ „ÿ«ÿÌ ⁄«·Ì." },
              { title: "√·Ê«‰ À«» … ÊÃ–«»…", desc: "‰” Œœ„ ’»€«  ⁄«·Ì… «·ÃÊœ…  ÷„‰ »ﬁ«¡ «·√·Ê«‰ “«ÂÌ… Õ Ï »⁄œ «·€”Ì· «·„ ﬂ——. „·«»” √ÿ›«· „ﬁ«Ê„… ··€”Ì·." },
            ].map((item, i) => (
              <motion.li
                key={i}
