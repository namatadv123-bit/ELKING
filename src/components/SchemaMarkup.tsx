...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "ItemList",
  name: "فوطه دفايه - قطن ليكرا - ملابس أطفال بالجملة",
  description: "تشكيلة مصنع الكينج من الفوط الدفايه وقطن الليكرا وملابس الأطفال بالجملة",
  numberOfItems: 9,
  itemListElement: [
    {
      "@type": "ListItem",
      ...
      item: {
        ...
        description: "فوطه دفايه مطبوعة بتصميم دبدوب جذاب. خامة ناعمة ومريحة، دافئة و user-friendly.",
        image: `${SITE_URL}/images/dadadub-fawater-dafaya.webp`,
    ...
    },
    {
      ...
      item: {
        ...
        description: "قطن ليكرا بطبعات مميزة ومتعددة. 7 تصاميم مختلفة تناسب جميع الأذواق.",
        image: `${SITE_URL}/images/matbou-qotn-lycra-1.webp`,
        brand: { "@type": "Brand", name: "مصنع الكينج" },
        offers: {
          "@type": "Offer",
          priceCurrency: "EGP",
